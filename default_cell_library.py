...
from karnaugh import KarnaughMap as Kmap
...
class Library:
    def __init__(self, default_library: bool = True):
        ...
        if default_library:
            ...
            for item in self._lib.values():
                self._mapping[item.truth_table] = item
    ...
    def mapping(self, mapping: Kmap):
        return self._mapping.get(mapping)
    ...
    def _load_deault_library(self):
        self._lib["inv"] = Cell("inv", ["din", "dout"], ["din"], "dout", 2, 2, 1)
